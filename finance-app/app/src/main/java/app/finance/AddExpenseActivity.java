...
public class AddExpenseActivity extends AppCompatActivity {
    ...
    private static final String[] CATEGORIES = {
            "Select Expense Category", "Food", "Rent", "Utilities", 
            "Transport", "Healthcare", "Shopping", "Entertainment", "Miscellaneous"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText("Provision New Expense");
        tvTitle.setTextColor(0xFFCF6679);
    ...
    private void submitRecord() {
        ...
        Record r = new Record(amount, "expense", cat, date, notes.isEmpty() ? "Expense Entry" : notes);
        r.setTargetUserId(targetUserId);

        viewModel.addRecord(currentUserId, r).observe(this, response -> {
            if (response != null && response.isSuccess()) {
                Toast.makeText(this, "Expense reported successfully", Toast.LENGTH_SHORT).show();
                finish();
            } else {
